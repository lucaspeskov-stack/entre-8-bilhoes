/**
 * Glifo oficial do WhatsApp em monocromia (`currentColor`), para acompanhar a
 * cor do botão em que estiver. Decorativo: quem lê o rótulo do botão já sabe
 * do que se trata, então fica `aria-hidden`.
 */
export default function WhatsAppGlyph({ className = 'h-[18px] w-[18px]' }) {
  return (
